...
router.post("/", protect, admin, validate(softwareCreateSchema), createSoftware);
router.post("/:id/assign", protect, admin, validate(idParamsSchema, "params"), validate(softwareAssignSchema), assignUser);
