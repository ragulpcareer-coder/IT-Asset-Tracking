...
router.get("/integrity", protect, admin, validate(integrityQuerySchema, "query"), async (req, res) => {
  try {
...
router.get("/export", protect, admin, validate(dateRangeQuerySchema, "query"), async (req, res) => {
  try {
